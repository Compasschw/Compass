...
function CredentialIcon({ type }: { type: Credential['type'] }) {
  switch (type) {
    case 'chw_certification':
      return (
        <div className="w-9 h-9 rounded-[12px] bg-[rgba(107,143,113,0.15)] flex items-center justify-center shrink-0">
    ...
    case 'background_check':
      return (
        <div className="w-9 h-9 rounded-[12px] bg-amber-50 flex items-center justify-center shrink-0">
    ...
    <div className="relative shrink-0">
      ...
      <div className="relative w-20 h-20 md:w-24 md:h-24">
        {imageUrl ? (
          ...
          <div
            className="w-full h-full rounded-full bg-[rgba(107,143,113,0.15)] border-4 border-white shadow-md flex items-center justify-center font-bold text-[#6B8F71] text-2xl"
            aria-hidden="true"
          >
            {initials}
          </div>
      ...
      {Array.from({ length: 5 }, (_, i) => {
        ...
        return (
          <Star
            ...
            size={14}
            className={
              filled ? 'text-yellow-400 fill-yellow-400' : 'text-[rgba(44,62,45,0.1)] fill-[rgba(44,62,45,0.1)]'
            }
            aria-hidden="true"
          />
        );
...
function AvailabilityToggle({ isAvailable, onChange }: AvailabilityToggleProps) {
  return (
    <button
      ...
      className={[
        'relative inline-flex h-8 w-14 shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#6B8F71]',
        isAvailable ? 'bg-[#2C3E2D]' : 'bg-[rgba(44,62,45,0.1)]',
      ].join(' ')}
    >
      <span
        className={[
    ...
    <div className="flex items-start gap-3 py-3 border-b border-[#F3F4F6] last:border-b-0">
      ...
      <div className="flex-1 min-w-0">
        <div className="flex items-center gap-2 flex-wrap mb-0.5">
          <span className="text-sm font-semibold text-[#2C3E2D]">{credential.label}</span>
          <span
        ...
        {isCE && credential.creditHours != null && credential.requiredHours != null && (
          <div className="mt-2">
            ...
            <div
              className="w-full h-1.5 bg-[rgba(44,62,45,0.1)] rounded-full overflow-hidden"
              role="progressbar"
            ...
            >
              <div
                className="h-full bg-[#2C3E2D] rounded-full transition-all"
                style={{
  ...
  return (
    <div className="max-w-3xl mx-auto space-y-6 pb-28">
            ...
            <div className="flex items-start justify-between gap-3">
              <div className="min-w-0">
                <h2
                  ...
                  className="text-xl font-bold text-[#2C3E2D] leading-tight"
                >
                  {displayName}
                </h2>
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-sm font-medium text-[#2C3E2D]">{displayName}</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-sm font-medium text-[#2C3E2D]">{display.phone}</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-sm font-medium text-[#2C3E2D] truncate">{display.email}</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-sm font-medium text-[#2C3E2D]">{display.zipCode}</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3">
              <div
                className="w-9 h-9 rounded-[12px] bg-[#FBF7F0] border border-[rgba(44,62,45,0.1)] flex items-center justify-center shrink-0 mt-0.5"
                aria-hidden="true"
              >
            ...
            {ALL_VERTICALS.map(({ key, label }) => {
              ...
              return (
                <button
                  ...
                  className={[
                    'flex items-center gap-1.5 px-3 py-1.5 rounded-full text-xs font-semibold border transition-all focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#6B8F71]',
                    isSelected
                      ? 'bg-[rgba(107,143,113,0.15)] border-[#6B8F71] text-[#6B8F71]'
                      : 'bg-white border-[rgba(44,62,45,0.1)] text-[#8B9B8D] hover:border-[#6B8F71] hover:text-[#6B8F71]',
                  ].join(' ')}
                >
            ...
            {(isEditing ? draft : saved).specializations.length > 0 ? (
              (isEditing ? draft : saved).specializations.map((vertical) => {
                ...
                return (
                  <span
                    key={vertical}
                    className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full text-xs font-semibold bg-[rgba(107,143,113,0.15)] text-[#6B8F71]"
                  >
              ...
              <p className="text-sm text-[#8B9B8D]">No specializations added yet.</p>
            )}
          </div>
        )}
      </section>
        ...
        {editingLanguages ? (
                ...
                <button
                  ...
                  className={[
                    ...
                    isSelected
                      ...
                      : 'bg-white border-[rgba(44,62,45,0.1)] text-[#8B9B8D] hover:border-[#0077B6] hover:text-[#0077B6]',
                  ].join(' ')}
                >
          ...
          <div className="flex flex-wrap gap-2">
            {(isEditing ? draft : saved).languages.length > 0 ? (
              ...
              <p className="text-sm text-[#8B9B8D]">No languages listed.</p>
            )}
          </div>
        )}
      </section>
      ...
      <section
        ...
        className="bg-white rounded-[20px] border border-[rgba(44,62,45,0.1)] p-4 space-y-4"
      >
        <h3
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-xs text-[#8B9B8D] mt-0.5">
              {isAvailable
        ...
        {/* Service radius */}
        <div className="flex items-center gap-3 pt-1 border-t border-[rgba(44,62,45,0.1)]">
          <div
            className="w-9 h-9 rounded-[12px] bg-[#FBF7F0] border border-[rgba(44,62,45,0.1)] flex items-center justify-center shrink-0"
            aria-hidden="true"
          >
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm font-semibold text-[#2C3E2D]">Mon – Fri, 9 AM – 5 PM</p>
          </div>
        </div>
      </section>
