...
// NOTE: the post-session star-rating prompt (Epic B2) moved out of this screen
// into the member-wide host PostSessionRatingGate — its tests now live in
// components/member/PostSessionRatingGate.test.tsx.
